...
<html>
  ...
  <header class="app-header"><a class="app-header__logo" href="utama.php">Apotik Gowok</a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Profil Customer</h1>
          <p>Table to display customer data</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <!-- <li class="breadcrumb-item active"><a href="#"></a></li> -->
                    ...
                    <?php 
                    $no=1; $tampil = mysqli_query($koneksi, "CALL GetPelanggan();");
                    ...
                    <?php while ($data=mysqli_fetch_assoc($tampil)) { ?>
                              ...
                              <td align="center">  
                                      <a href="edit_pelanggan.php?id= <?php echo $data['id_user']; ?>"><button class="btn btn-warning"> <i class="icon fa fa-pencil"></i>Edit</button>
                                      <a href="hapus_pelanggan.php?id= <?php echo $data['id_user']; ?>"><button class="btn btn-danger"> <i class="icon fa fa-trash"></i> Delete</button>
                              </td>
