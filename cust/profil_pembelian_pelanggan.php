...
<html>
  ...
  <header class="app-header"><a class="app-header__logo" href="">Apotik Gowok</a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Purchase Transaction </h1>
          <p>Table to display purchase transaction data</p>
        </div>
      ...
      <ul class="app-nav">
        <li class="app-search"><a href="tambah_pembelian_pelanggan.php"> <button type="button" class="btn btn-primary"> + Add Purchase Transaction </button> </a></li>
         <li class="app-search">
          <form action="profil_pembelian_pelanggan_act.php" method="GET">
            ...
            <?php 
                // $no=1; 
                $tampil = mysqli_query($koneksi, "SELECT * FROM data_pembelian_pelanggan where username = '".$_SESSION['username']."'");
            ...
            <?php if(isset($_GET['cari'])){
                ...
                if ($cari!="") {
                    // $tampil=mysqli_query($koneksi, "SELECT * FROM data_pembelian where nama_obat LIKE '%$cari%'");
                  $tampil=mysqli_query($koneksi, "CALL GetPembelianPelanggan('$cari')");
                }
            } while ($data=mysqli_fetch_assoc($tampil)) { ?>
        
            <td align="center"> <?php echo $data['id_pembelian_pelanggan'];?> </td>
            <td align="center"> <?php echo $data['tgl_beli_pelanggan'];?> </td>
            <td align="center"> <?php echo $data['nama_obat'];?> </td>
            <td align="center"> <?php echo $data['jumlah_beli_pelanggan'];?> </td>
            <td align="center" colspan="2">
                     
            <a href="edit_pembelian_pelanggan.php?id= <?php echo $data['id_pembelian_pelanggan']; ?>"> <button class="btn btn-warning"><i class="icon fa fa-pencil"></i> Edit</button></a>
            <a href="hapus_pembelian_pelanggan.php?id= <?php echo $data['id_pembelian_pelanggan']; ?>">
