...
<head>
  ...
  <header class="app-header"><a class="app-header__logo" href="utama.php">Apotik Gowok</a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
        <h1><i class="fa fa-edit"></i> Edit Supplier Medicine </h1>
          <p>Displaying supplier of medicine data</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Inventory</li>
          <li class="breadcrumb-item active"><a href="#">Edit Supplier Medicine</a></li>
        </ul>
      </div>
...
<div class="row">
                                <div class="col-md-6">
                                <div class="tile">
                                                <h3 class="tile-title">Form Edit Supplier</h3>
                                        <div class="tile-body">
                                                <form method="POST" action="proses_edit_supplier.php">
                                                <input name="id" hidden="hidden" value="<?php echo $data['id_supplier'];?>">
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">ID Supplier</label>
                                        <div class="col-md-8">
                                                <input class="form-control" type="text" name="id_supplier" disabled="" value="<?php echo $data['id_supplier']; ?>">
                                        </div>
                                     </div>
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Supplier Name</label>
                                        <div class="col-md-8">
                                                <input class="form-control" type="text" name="nama_supplier" value="<?php echo $data['nama_supplier']; ?>">
                                        </div>
                                     </div>
                                     <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                                <input class="form-control" type="text" name="telephone" value="<?php echo $data['no_telp']; ?>">
                                        </div>
                                     </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8 col-md-offset-3">
                          <button class="btn btn-primary" type="submit">
                            <i class="fa fa-fw fa-lg fa-check-circle"></i>Update</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="profil_suppliers.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                          </div>
                        </div>
                      </form>
                    </div>
