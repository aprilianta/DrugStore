...
<html>
  ...
  <header class="app-header"><a class="app-header__logo" href="utama.php">Apotik Gowok</a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
        <h1><i class="fa fa-edit"></i> Edit User Data </h1>
          <p>Displaying user data</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Profil User</li>
          <li class="breadcrumb-item active"><a href="#">Edit User Data</a></li>
        </ul>
      </div>
      <?php
        $id = $_GET['id'];
                          ...
                          <label class="control-label col-md-3">Occupation</label>
                            <div class="col-md-8">
                              <select name="jabatan" class="form-control">
                                ...
                                <option value="Apoteker Pendamping" <?php if($data['jabatan'] == "Apoteker Pendamping") echo "selected";?>>Apoteker Pendamping</option>
                              </select>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-8 col-md-offset-3">
                              <button class="btn btn-primary" type="submit">
                                 <i class="fa fa-fw fa-lg fa-check-circle"></i>Update</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="profil_user.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                           </div>
                        </div>
                        <?php } ?>
                      </form>
