...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2019 at 09:09 PM
...
(55, 'Customer01', '123', 'Kevin C', 'Yogyakarta', '082136699892', 'M', 'Pelanggan');
...
--
ALTER TABLE `pembelian_pelanggan`
  MODIFY `id_pembelian_pelanggan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
