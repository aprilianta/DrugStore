...
<html>
  ...
  <header class="app-header"><a class="app-header__logo" href="utama.php">Apotik Gowok</a>
    ...
    <main class="app-content">
      ...
      <ul class="app-nav">
        <li class="app-search"><a href="tambah_pembelian.php"> <button type="button" class="btn btn-primary"> + Add Purchase Transaction </button> </a></li>
         <li class="app-search">
          <form action="profil_pembelian_act.php" method="GET">
            ...
            <?php 
                // $no=1; 
                $tampil = mysqli_query($koneksi, "SELECT * FROM data_pembelian");
            ...
            <?php if(isset($_GET['cari'])){
                ...
                if ($cari!="") {
                  ...
                  $tampil=mysqli_query($koneksi, "CALL GetPembelian('$cari')");
                }
            } while ($data=mysqli_fetch_assoc($tampil)) { ?>
        
            <td align="center"> <?php echo $data['id_pembelian'];?> </td>
            <td align="center"> <?php echo $data['id_receipt_beli'];?> </td>
