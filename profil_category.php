...
<html>
  ...
  <header class="app-header"><a class="app-header__logo" href="utama.php">Apotik Gowok</a>
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Inventory</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="profil_obat.php"><i class="icon fa fa-circle-o"></i> Medicine</a></li>
             <li><a class="treeview-item active" href="profil_category.php"><i class="icon fa fa-circle-o"></i> Category</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-laptop"></i> Category Inventory </h1>
          <p>Table to display category of medicine data</p>
        </div>
      ...
      <ul class="app-nav">
        <li class="app-search"><a href="tambah_kategori.php"> <button type="button" class="btn btn-primary"> + Add Category </button> </a></li>
         <li class="app-search">
          <form action="profil_category_act.php" method="GET">
            <input class="app-search__input" type="text" placeholder="Search category" name="cari">
            ...
            <?php 
                // $no=1; 
                $tampil = mysqli_query($koneksi, "SELECT * FROM kategori WHERE id_kategori > 0");
            ...
            <?php if(isset($_GET['cari'])){
                ...
                if ($cari!="") {
                  ...
                  $tampil=mysqli_query($koneksi, "CALL GetCategory('$cari')");
                }
            }  while ($data=mysqli_fetch_array($tampil)) { ?>
            <td align="center"> <?php echo $data['id_kategori'];?> </td>
            <td align="center"> <?php echo $data['nama_kategori'];?> </td>
            <td align="center"> 
                    <a href="edit_kategori.php?id= <?php echo $data['id_kategori']; ?>"> <button class="btn btn-warning"> <i class="icon fa fa-pencil"></i> Edit</button></a>
                    <a href="hapus_kategori.php?id= <?php echo $data['id_kategori']; ?>"> <button class="btn btn-danger"> <i class="icon fa fa-trash"></i> Hapus</button></a>
            </td>
        </tr>
                <?php } }?>
    </table>
