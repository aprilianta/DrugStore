...
<html>
  ...
  <header class="app-header"><a class="app-header__logo" href="utama.php">Apotik Gowok</a>
      ...
      <ul class="app-nav">
        <!-- <li class="app-search">
          <form action="profil_obat_act.php" method="GET">
            <input class="app-search__input" type="text" placeholder="Search" name="cari">
    ...
    <main class="app-content">
      ...
      <ul class="app-nav">
        <li class="app-search"><a href="tambah_obat.php"> <button type="button" class="btn btn-primary">    + Add Medicine </button> </a></li>
         <li class="app-search">
          <form action="profil_obat_act.php" method="GET">
